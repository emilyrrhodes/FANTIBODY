...
class MyLoop(LoopModel):
    ...
    def select_loop_atoms(self):
        ...
        return Selection(self.residue_range('222:A', '227:A'))
        # Two loops simultaneously - remove hashtag to make this possible
        #return Selection(self.residue_range('19:A', '28:A'),
        #                 self.residue_range('38:A', '42:A'))

m = MyLoop(env,
           inimodel='4llu_modeller_A.pdb',   # initial model of the target
           sequence='4llu',                 # code of the target
